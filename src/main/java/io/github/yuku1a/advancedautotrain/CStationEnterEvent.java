...
/**
 * 列車がCStationに入ったことを示すイベント
 */
public class CStationEnterEvent extends Event{
    /**
     * イベントが発火されたレールの位置
     ...
     */
    public CStationEnterEvent(Location railLocation, MinecartGroup train, String CStationName, boolean acted) {
